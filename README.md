...
See an example of this theme in action on the [theme's official site]([https://tareqdandachi.github.io/jekyll-shell-theme](https://www.itstorque.com/jekyll-shell-theme/)).
